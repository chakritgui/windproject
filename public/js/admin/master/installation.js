        ...
        initComplete: function(){
            ...
            let btn = `
                <button class="btn btn-primary btn-sm manage-installation" data-id="">
                    <i class="fa-solid fa-plus"></i> <span data-i18n="installation"></span>
                </button>
            `;
            $filter.append(btn);
            var input = $('#tb_installation_filter input').unbind();
        ...
        success: function(res) {
            if(res.status === true){
                ...
                modalEl.find(".modal-header").html(`
                    <h5 class="modal-title" data-i18n="${(installations_id) ? 'manageInstallation' : 'newInstallation'}"></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                `);
                modalEl.find(".modal-footer").html(`
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" data-i18n="close"></button>
                    <button type="submit" class="btn btn-primary save-installation" data-i18n="save"></button>
                `);
