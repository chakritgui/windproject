            ...
            render: function (status, type, row) {
                ...
                return `
                    <div class="form-check form-switch mb-0">
                        <input class="form-check-input update-item-switch" type="checkbox" role="switch"id="switch_${row.project_group_id}" data-id="${row.project_group_id}" data-type="group" ${isChecked} style="cursor:pointer;">
                    </div>
                `;
            }
        },{ 
