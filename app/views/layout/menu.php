<div id="sidebar" class="sidebar d-flex flex-column">
    ...
    <ul class="list-unstyled mt-3 flex-grow-1 overflow-auto">
        <?php if(isset($_SESSION['user']['role']) && in_array($_SESSION['user']['role'], ['admin','administrator'])) { ?>
            <li><a href="<?=BASE_URL?>/dashboard" class="sidebar-link <?=($GLOBALS['currentRoute']=='/dashboard'?'active':'')?>"><i class="fa-solid fa-chart-pie"></i> <span data-i18n="dashboard"></span></a></li>
