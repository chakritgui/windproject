<?php
// 1. Session Configuration (ต้องอยู่ก่อน session_start)
...
// 5. [CORE LOGIC] หน้าแรก (/)
// ใช้ฟังก์ชันตรวจสอบข้างใน เพื่อไม่ให้ Service Worker จำหน้าผิด
$router->get('/', function() {
...
// 6. รูทที่เข้าได้ตลอด (Public Routes)
...
// 7. รูทตามสิทธิ์การใช้งาน (Conditional Routes)
if (isset($_SESSION['user'])) {
    $role = $_SESSION['user']['role'] ?? '';
