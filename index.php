<?php
    ...
    if (isset($_SESSION['user'])) {
        ...
        if ($role === 'admin' || $role === 'administrator') {
            ...
            $router->post('/api/contracts.updateStatus', 'ContractsController@updateStatus');
            ...
            $router->post('/api/group.updateStatus', 'GroupController@updateStatus');
            ...
            $router->post('/api/level.updateStatus', 'LevelController@updateStatus');
            ...
            $router->post('/api/project.status.updateStatus', 'StatusController@updateStatus');
            ...
            $router->post('/api/projects.updateStatus', 'ProjectsController@updateStatus');
            ...
            $router->post('/api/types.updateStatus', 'TypesController@updateStatus');
            ...
            $router->post('/api/poles.updateWind', 'PolesController@updateWind');
            ...
            $router->post('/api/installations.updateStatus', 'InstallationsController@updateStatus');
            ...
            $router->get('/api/wind.current', 'MapController@weatherWind');
            $router->get('/api/weather.current', 'MapController@weatherCurrent');
            $router->get('/api/weather.wind', 'MapController@weatherWindFromDB');
            ...
            $router->get('/api/wind/latest', 'MapController@getLatestWind');
        }
    }
