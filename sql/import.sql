...
('footer_en', NULL, NOW(), NOW()),
('footer_lo', NULL, NOW(), NOW()),
('footer_th', NULL, NOW(), NOW()),
('scrolling_en', NULL, NOW(), NOW()),
('scrolling_lo', NULL, NOW(), NOW()),
('scrolling_th', NULL, NOW(), NOW()),
('site_assessment_en', NULL, NOW(), NOW()),
('site_assessment_lo', NULL, NOW(), NOW()),
('site_assessment_th', NULL, NOW(), NOW()),
...
(1, 'PROJECT', 'project', 'folder', 1, NULL, NULL, NULL, 'active', NOW(), NOW()),
(2, 'MEASUREMENT STATION', 'measument-station', 'folder', 1, NULL, NULL, NULL, 'active', NOW(), NOW()),
(3, 'EIA / EHIA', 'eia-ehia', 'folder', 1, NULL, NULL, NULL, 'active', NOW(), NOW()),
(4, 'PDA / PPA / CA', 'pda-ppa-ca', 'folder', 1, NULL, NULL, NULL, 'active', NOW(), NOW());
